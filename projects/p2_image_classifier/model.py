...
# def build_two_layer_classifer(inputs=2208, hidden_one=512, hidden_two=256, outputs=102, p=0.2):
#     return TwoLayerClassifier(inputs, hidden_one, hidden_two, outputs, p)
...
#     classifier = build_two_layer_classifer(
#         checkpoint['inputs'],
